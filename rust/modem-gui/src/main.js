...
function setupSdrBusHandlers() {
  ...
  // sdr:refresh-radio-gain / sdr:refresh-radio-sdr-params and the Radio half of
  // capture:started are subscribed inside tabs/radio.js (setupRadioTab), so the
  // Radio renderers live with the Radio tab. lib/capture.js emits capture:started
  // so the RX/TX/Settings chips refresh without the lifecycle importing a tab.
